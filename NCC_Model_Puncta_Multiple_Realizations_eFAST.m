function Summary_Statistics = NCC_Model_Puncta_Multiple_Realizations_eFAST(parameter_set_number, number_of_realizations)
...
if make_video
    ...
    system(strcat('mkdir ./NCC_puncta_model_output_data_eFAST/', video_title)); 
    system(strcat('mv ./output/* ./NCC_puncta_model_output_data_eFAST/',video_title) );
    system('touch ./output/empty.txt');
    system(['cd ./NCC_puncta_model_output_data_eFAST/',video_title,' && tar -zcf ',video_title,'.tar.gz * && mv ',video_title,'.tar.gz ../ && cd -']);
    system(['rm -rf ./NCC_puncta_model_output_data_eFAST/',video_title]);
end
end