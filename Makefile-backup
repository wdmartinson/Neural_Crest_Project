...
vicsek-model:
	cp ./vicsek_model/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./vicsek_model/main-vicsek_model.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./vicsek_model/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./vicsek_model/config/* ./config/

cell-ecm-model:
	cp ./Cell-ECM-Toy-Model/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./Cell-ECM-Toy-Model/main-cell-ECM-model.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./Cell-ECM-Toy-Model/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./Cell-ECM-Toy-Model/config/* ./config/

ncc-model:
	cp ./NCC_model/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./NCC_model/main-ncc.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./NCC_model/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./NCC_model/config/* ./config/

ncc-model-test:
	cp ./NCC_model_test/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./NCC_model_test/main-ncc.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./NCC_model_test/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./NCC_model_test/config/* ./config/

ncc-model-puncta:
	cp ./NCC_puncta_model/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./NCC_puncta_model/main-ncc.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./NCC_puncta_model/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./NCC_puncta_model/config/* ./config/

ncc-puncta-experiments:
	cp ./NCC_puncta_experiments/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./NCC_puncta_experiments/main-ncc.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./NCC_puncta_experiments/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./NCC_puncta_experiments/config/* ./config/

moore-test:
	cp ./moore_test/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./moore_test/main-moore.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./moore_test/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./moore_test/config/* ./config/
